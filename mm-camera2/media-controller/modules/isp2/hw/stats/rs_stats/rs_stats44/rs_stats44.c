  ...
  void *data)
{
  ...
  pcmd->shiftBits = isp_sub_module_util_calculate_shift_bits(rgn_width * rgn_height,
  ...
  void *data)
{
  ...
  ISP_ERR("max_stripe_offset %u mid pt %u", stripe_limit->max_stripe_offset, mid_point);
