...
typedef struct _af_lens_params{
  ...
  float                                     lens_pos_hypf;                       /**< Hyperfocal Lens position*/
...
typedef struct
{
  ...
  af_core_pdaf_info_t       pdaf_update[MAX_DEPTH_WINDOW_SIZE];/**< Pdaf info */
...
typedef enum
{
    ...
    AF_CORE_SET_FOLLOW_MODE,                                     /**< Set AF into Follow Mode */
...
typedef struct
{
    ...
    union
    {
        ...
        boolean                            af_follow_mode;         /**< AF Algorithm in  Follow Mode or not*/
