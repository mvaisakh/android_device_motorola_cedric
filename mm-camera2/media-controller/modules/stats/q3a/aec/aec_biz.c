...
static boolean aec_biz_map_set_param(aec_biz_t *aec, aec_set_parameter_t *param)
{
  ...
  case AEC_SET_PARAM_LED_CALIB_ENABLE:
    set_param.type = AEC_SET_LED_CALIB_ENABLE;
    set_param.u.led_calib_data.enabled = param->u.led_calib_enable;
    set_param.u.led_calib_data.prefered_exp_index =
      LED_CALIB_AEC_PREFERED_EXP_INDEX;
    break;
