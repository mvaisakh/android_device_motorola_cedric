...
/* This flag decides whether to use aec init setting from last camera session.
 * This feature is bydefault enabled in instant capture */
#define AEC_START_RESTORE FALSE
...
#define AEC_SET_PARAM_ENUM_LIST(ADD_ENTRY)                                    \
  ...
  ADD_ENTRY(AEC_SET_PARAM_PREP_FOR_SNAPSHOT_LEGACY)                           \
  ...
  /* Disable/Enable ADRC */                                                   \
  ADD_ENTRY(AEC_SET_PARAM_ADRC_ENABLE)                                        \
  ...
  ADD_ENTRY(AEC_SET_PARAM_LED_CALIB_ENABLE)                                   \
