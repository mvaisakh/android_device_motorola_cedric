...
IMX378_CHROMATIX_SW_POST_PROC_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX378_CHROMATIX_SW_POST_PROC_PATH)
...
LOCAL_C_INCLUDES += chromatix_imx378_sw_post_proc.h

LOCAL_SRC_FILES:= chromatix_imx378_sw_post_proc.c
