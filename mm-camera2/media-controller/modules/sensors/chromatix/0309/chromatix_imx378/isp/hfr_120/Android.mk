...
IMX378_CHROMATIX_HFR_120_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX378_CHROMATIX_HFR_120_PATH)
...
LOCAL_C_INCLUDES += chromatix_imx378_hfr_120.h

LOCAL_SRC_FILES:= chromatix_imx378_hfr_120.c
