...
IMX378_CHROMATIX_PREVIEW_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX378_CHROMATIX_PREVIEW_PATH)
...
LOCAL_C_INCLUDES += chromatix_imx378_preview.h

LOCAL_SRC_FILES:= chromatix_imx378_preview.c
