...
IMX378_CHROMATIX_HFR_60_CPP_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX378_CHROMATIX_HFR_60_CPP_PATH)
...
LOCAL_C_INCLUDES += chromatix_imx378_hfr_60_cpp.h

LOCAL_SRC_FILES:= chromatix_imx378_hfr_60_cpp.c
