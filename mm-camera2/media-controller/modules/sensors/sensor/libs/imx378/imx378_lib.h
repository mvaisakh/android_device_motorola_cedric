...
#ifndef __IMX378_TRON_LIB_H__
#define __IMX378_TRON_LIB_H__

#include "sensor_lib.h"
#define SENSOR_MODEL "imx378_tron"

/* IMX378_TRON REGISTERS */
#define IMX378_TRON_DIG_GAIN_GR_ADDR           0x020E
#define IMX378_TRON_DIG_GAIN_R_ADDR            0x0210
#define IMX378_TRON_DIG_GAIN_B_ADDR            0x0212
#define IMX378_TRON_DIG_GAIN_GB_ADDR           0x0214
#define IMX378_TRON_EXP_RATIO_ADDR             0x0222
#define IMX378_TRON_ABS_GAIN_R_WORD_ADDR       0x0B90
#define IMX378_TRON_ABS_GAIN_B_WORD_ADDR       0x0B92
#define IMX378_TRON_SHORT_COARSE_INT_TIME_ADDR 0x0224
#define IMX378_TRON_SHORT_GAIN_ADDR            0x0216
...
/* IMX378_TRON CONSTANTS */
#define IMX378_TRON_MAX_INTEGRATION_MARGIN   10

#define IMX378_TRON_CSI_HDR_ISTATS           0x35
#define IMX378_TRON_CSI_PD_ISTATS            0x36
#define IMX378_TRON_DATA_PEDESTAL            0x40    /* 10bit value */

#define IMX378_TRON_MIN_AGAIN_REG_VAL        0       /* 1.0x */

/* IMX378_MAX_AGAIN_REG_VAL is 978=0x3D2
 * Maximum Analog Gain: 22.261 times
 * only use Maximum Analog Gain 16 times here.
 */
#define IMX378_TRON_MAX_AGAIN_REG_VAL        977     /* 16.0x */
#define IMX378_TRON_MIN_DGAIN_REG_VAL        256     /* 1.0x */
#define IMX378_TRON_MAX_DGAIN_REG_VAL        511     /* 2.0x */
#define IMX378_TRON_MAX_DGAIN_DECIMATOR      256

/* IMX378_TRON FORMULAS */
#define IMX378_TRON_MIN_AGAIN    (1024 / (1024 - IMX378_TRON_MIN_AGAIN_REG_VAL))
#define IMX378_TRON_MAX_AGAIN    (1024 / (1024 - IMX378_TRON_MAX_AGAIN_REG_VAL))

#define IMX378_TRON_MIN_DGAIN    (IMX378_TRON_MIN_DGAIN_REG_VAL / 256)
#define IMX378_TRON_MAX_DGAIN    (IMX378_TRON_MAX_DGAIN_REG_VAL / 256)

#define IMX378_TRON_MIN_GAIN     IMX378_TRON_MIN_AGAIN * IMX378_TRON_MIN_DGAIN
#define IMX378_TRON_MAX_GAIN     IMX378_TRON_MAX_AGAIN * IMX378_TRON_MAX_DGAIN
...
static sensor_lib_t sensor_lib_ptr =
{
  .sensor_slave_info =
  {
    ...
    .slave_addr = 0x34,
    /* VERTU - hongzhang - BUG-2343693,2579808*/
    //.i2c_freq_mode = SENSOR_I2C_MODE_FAST,
    //QCT case 02558198. waveform will more stable
    .i2c_freq_mode = SENSOR_I2C_MODE_STANDARD,
    /* end vertu - BUG-2343693,2579808*/
  ...
  .sensor_output =
  {
    ...
    .filter_arrangement = SENSOR_BGGR, // MODIFIED by yongzhi.li, 2016-10-21,BUG-3201127
  },
  .output_reg_addr =
  {
    .x_output = 0x034C,
  ...
  .exp_gain_info =
  {
    ...
    .vert_offset = IMX378_TRON_MAX_INTEGRATION_MARGIN,
  },
  .aec_info =
  {
    .min_gain = IMX378_TRON_MIN_GAIN,
    /* MODIFIED-BEGIN by hongzhang, 2016-11-14,BUG-3462818*/
    .max_gain = 32,
    // .max_gain = IMX378_TRON_MAX_GAIN,
    /* MODIFIED-END by hongzhang,BUG-3462818*/
    .max_analog_gain = IMX378_TRON_MAX_AGAIN,
    .max_linecount = 65535 * 2 - IMX378_TRON_MAX_INTEGRATION_MARGIN,
  },
  ...
  {
    .white_level = 1023,
    .r_pedestal = IMX378_TRON_DATA_PEDESTAL,
    .gr_pedestal = IMX378_TRON_DATA_PEDESTAL,
    .gb_pedestal = IMX378_TRON_DATA_PEDESTAL,
    .b_pedestal = IMX378_TRON_DATA_PEDESTAL,
  },
  ...
  .out_info_array =
  {
    .out_info =
    {
      /* Res 0 */
      {
        ...
        .vt_pixel_clk = 484800000,
        .op_pixel_clk = 484800000,
        .binning_factor = 1,
        .min_fps = 7.50,
        .max_fps = 30.31,
  ...
  .sensorlib_pdaf_api =
  {
    .calcdefocus = "imx378_tron_pdaf_calculate_defocus",
    .libname = "libSonyIMX378PdafLibrary.so",
