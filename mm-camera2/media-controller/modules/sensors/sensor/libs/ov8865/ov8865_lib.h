...
#ifndef __OV8865_LIB_H__
#define __OV8865_LIB_H__

#include "sensor_lib.h"
#define SENSOR_MODEL "ov8865"

#define MIN_GAIN 1
#define MAX_ANALOG_GAIN (15.5)
#define MAX_DIGITAL_GAIN (8)
...
{ \
  ...
  {0x380c, 0x07, 0x00}, \
  {0x380d, 0x83, 0x00}, \
  {0x380e, 0x04, 0x00}, /*changed from e0*/ \
  {0x380f, 0xe0, 0x00}, \
  {0x3810, 0x00, 0x00}, \
  {0x3811, 0x04, 0x00}, \
  {0x3813, 0x04, 0x00}, \
  ...
  .out_info_array =
  {
    .out_info =
    {
      /* Res 0 */
      {
        ...
        .y_output = 2448,
       /*
        Here we set HTS to 1944 according to OV's new representation for
        OV8865, but actual timing for HTS is 1934*2, which is 3868.
       */
        .line_length_pclk = 1936,
        .frame_length_lines = 2496,
        .vt_pixel_clk = 144400000,
      ...
      /* Res 1 */
      {
        ...
        .y_output = 1224,
        /*
         Here we set HTS to 1923 according to OV's new representation for
         OV8865, but actual timing for HTS is 1910*2, which is 3820.
        */
        .line_length_pclk = 1923,
        .frame_length_lines = 1256,//1248,
      ...
      /* Res 2 */
      {
        ...
        .y_output = 792,
        /*
         Here we set HTS to 2170 according to OV's new representation for
         OV8865, but actual timing for HTS is 2170*2, which is 4340.
        */
        .line_length_pclk = 1470,
