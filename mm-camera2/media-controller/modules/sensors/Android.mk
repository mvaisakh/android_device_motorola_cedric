...
ifeq ($(call is-board-platform-in-list,msm8974 msm8960 msm7627a msm8660 msm8916 msm8226 msm8952 msm8610 apq8084 msm8994 msm8996 msm8992 msm8937 msm8953 msmcobalt msmfalcon),true)
...
LOCAL_CFLAGS += -DMSM8996_SENSORS
LOCAL_CFLAGS += -DTCT_TARGET_MM_CAMERA_SIMBA6X_USE_ONLY
else ifeq ($(call is-board-platform-in-list, msm8952),true)
LOCAL_CFLAGS  += -DMSM8952_SENSORS
else ifeq ($(call is-board-platform-in-list, msm8976),true)
LOCAL_CFLAGS  += -DMSM8976_SENSORS
