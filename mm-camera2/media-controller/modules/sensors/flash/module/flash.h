...
#define COND_REPLACE(a, b) ((-1 != (a)) ? (a) : (b)) // MODIFIED by XuNan, 2016-10-31,BUG-3276581
...
{
  uint8_t  enable;
  int32_t  led1_setting;
  int32_t  led2_setting;
}test_dualled_setting_t;
...
typedef struct {
  ...
  test_dualled_setting_t    *test_dualled_setting; // MODIFIED by yongzhi.li, 2016-09-21,BUG-2579753
} sensor_flash_data_t;
