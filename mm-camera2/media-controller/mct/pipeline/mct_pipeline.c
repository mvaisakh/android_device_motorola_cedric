...
static cam_dimension_t default_preview_sizes[] = {
  ...
  { 1920, 1080}, // 1080p
  { 1440, 1080}, // Wide HD
  { 1080, 1080}, // 1:1 preview // MODIFIED by hongzhang, 2016-11-01,BUG-3273403
  { 1280, 960},
...
static cam_dimension_t default_picture_sizes[] = {
  ...
  { 3200, 2400}, // 8MP
  /* MODIFIED-BEGIN by hongzhang, 2016-10-29,BUG-3273403*/
  { 3200, 1800}, // 6MP with 16:9
  { 2976, 2976},
  { 2812, 2812}, // 8MP with 1:1
  /* MODIFIED-END by hongzhang,BUG-3273403*/
  { 2448, 2448}, // MODIFIED by hongzhang, 2016-10-26,BUG-3230870
  { 2592, 1944}, // 5MP
  { 2688, 1512}, // 4MP wide
  { 2048, 1536}, // 3MP QXGA
  { 1920, 1080}, // HD1080
...
static cam_dimension_t default_video_sizes[] = {
  ...
  /* MODIFIED-BEGIN by hongzhang, 2016-10-29,BUG-3273403*/
  { 160, 120},
  { 720, 720},  // Needed by GAPP micro-video
  { 960, 540}  // QHD. Follow m8976.
  /* MODIFIED-END by hongzhang,BUG-3273403*/
};
